...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSString *bundlePath = [resourcePath stringByAppendingPathComponent:@"SegmentedControl2.bundle"];
...
- (UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view
{
    ...
    if (self.textFont) label.font = self.textFont;
    if (self.textColor) label.textColor = self.textColor;
